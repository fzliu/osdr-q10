...
#
# Generated by export_simulation on Wed Aug 22 10:12:33 CST 2018
#
################################################################################
...
'-reset_run' switch to the './math_mult_32.sh' script.

./math_mult_32.sh -reset_run
...
./math_mult_32.sh -noclean_files

For more information on the script, please type './math_mult_32.sh -help'.

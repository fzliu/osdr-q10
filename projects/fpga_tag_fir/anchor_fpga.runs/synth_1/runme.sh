...
HD_PWD='/home/fzliu/orion/code/orion-anchor/projects/fpga_tag_fir/anchor_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log anchor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source anchor_top.tcl

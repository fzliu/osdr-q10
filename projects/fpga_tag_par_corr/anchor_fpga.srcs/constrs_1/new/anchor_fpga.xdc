...
set_property PACKAGE_PIN R21 [get_ports ebi_clk]
set_property IOSTANDARD LVCMOS33 [get_ports ebi_clk]
...
set_property PACKAGE_PIN K26 [get_ports {ebi_addr[0]}]
set_property PACKAGE_PIN L25 [get_ports {ebi_addr[1]}]
set_property PACKAGE_PIN M26 [get_ports {ebi_addr[2]}]
set_property PACKAGE_PIN P23 [get_ports {ebi_addr[3]}]
set_property PACKAGE_PIN P25 [get_ports {ebi_addr[4]}]
set_property PACKAGE_PIN K25 [get_ports {ebi_addr[5]}]
set_property PACKAGE_PIN N26 [get_ports {ebi_addr[6]}]
set_property PACKAGE_PIN M25 [get_ports {ebi_addr[7]}]
set_property PACKAGE_PIN P26 [get_ports {ebi_addr[8]}]
set_property PACKAGE_PIN R26 [get_ports {ebi_addr[9]}]
set_property PACKAGE_PIN R22 [get_ports {ebi_addr[10]}]
set_property PACKAGE_PIN R25 [get_ports {ebi_addr[11]}]
set_property PACKAGE_PIN T25 [get_ports {ebi_addr[12]}]
set_property PACKAGE_PIN N23 [get_ports {ebi_addr[13]}]
set_property PACKAGE_PIN N24 [get_ports {ebi_addr[14]}]
set_property PACKAGE_PIN N19 [get_ports ebi_nrde]
set_property PACKAGE_PIN P19 [get_ports ebi_nwre]
...
set_property DRIVE 4 [get_ports ebi_nwre]

set_property DRIVE 12 [get_ports {ebi_addr[14]}]
set_property DRIVE 12 [get_ports {ebi_addr[13]}]
set_property DRIVE 12 [get_ports {ebi_addr[12]}]
set_property DRIVE 12 [get_ports {ebi_addr[11]}]
set_property DRIVE 12 [get_ports {ebi_addr[10]}]
set_property DRIVE 12 [get_ports {ebi_addr[9]}]
set_property DRIVE 12 [get_ports {ebi_addr[8]}]
set_property DRIVE 12 [get_ports {ebi_addr[7]}]
set_property DRIVE 12 [get_ports {ebi_addr[6]}]
set_property DRIVE 12 [get_ports {ebi_addr[5]}]
set_property DRIVE 12 [get_ports {ebi_addr[4]}]
set_property DRIVE 12 [get_ports {ebi_addr[3]}]
set_property DRIVE 12 [get_ports {ebi_addr[2]}]
set_property DRIVE 12 [get_ports {ebi_addr[1]}]
set_property DRIVE 12 [get_ports {ebi_addr[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports ebi_nwre]

set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ebi_addr[0]}]

set_property SLEW FAST [get_ports {ebi_addr[14]}]
set_property SLEW FAST [get_ports {ebi_addr[13]}]
set_property SLEW FAST [get_ports {ebi_addr[12]}]
set_property SLEW FAST [get_ports {ebi_addr[11]}]
set_property SLEW FAST [get_ports {ebi_addr[10]}]
set_property SLEW FAST [get_ports {ebi_addr[9]}]
set_property SLEW FAST [get_ports {ebi_addr[8]}]
set_property SLEW FAST [get_ports {ebi_addr[7]}]
set_property SLEW FAST [get_ports {ebi_addr[6]}]
set_property SLEW FAST [get_ports {ebi_addr[5]}]
set_property SLEW FAST [get_ports {ebi_addr[4]}]
set_property SLEW FAST [get_ports {ebi_addr[3]}]
set_property SLEW FAST [get_ports {ebi_addr[2]}]
set_property SLEW FAST [get_ports {ebi_addr[1]}]
set_property SLEW FAST [get_ports {ebi_addr[0]}]
set_property SLEW FAST [get_ports ebi_nwre]
...
set_false_path -from [get_ports {ebi_addr[*]}] -to [get_clocks -of_objects [get_pins anchor_clk_gen/*]]
set_false_path -from [get_ports ebi_nwre] -to [get_clocks -of_objects [get_pins anchor_clk_gen/*]]
set_false_path -from [get_ports {ebi_data[*]}] -to [get_clocks -of_objects [get_pins anchor_clk_gen/*]]

set_input_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 0.000 [get_ports {ebi_data[*]}]
set_input_delay -clock [get_clocks a_rx_clk_in] -max -add_delay 1.000 [get_ports {ebi_data[*]}]
set_input_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 0.000 [get_ports {ebi_addr[*]}]
set_input_delay -clock [get_clocks a_rx_clk_in] -max -add_delay 1.000 [get_ports {ebi_addr[*]}]
...
set_input_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 0.000 [get_ports ebi_nwre]
set_input_delay -clock [get_clocks a_rx_clk_in] -max -add_delay 1.000 [get_ports ebi_nwre]

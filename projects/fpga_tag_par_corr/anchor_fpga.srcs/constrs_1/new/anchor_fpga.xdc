...
set_clock_groups -name sys_ss_async6 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {pll_out[2]}]
...
set_clock_groups -name sys_ss_async3 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async3 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
set_clock_groups -name sys_ss_async3 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[0]}]
set_clock_groups -name sys_ss_async4 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async3 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
set_clock_groups -name sys_ss_async5 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[0]}]
set_clock_groups -name sys_ss_async5 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async5 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]

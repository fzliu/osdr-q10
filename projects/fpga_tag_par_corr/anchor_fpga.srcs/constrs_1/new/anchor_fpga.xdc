...
set_false_path -from [get_ports ena] -to [get_clocks *]
set_false_path -from [get_ports ebi_nrde] -to [get_clocks *]
...
set_output_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 1.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 0.000 [get_ports ebi_ready]
set_output_delay -clock [get_clocks a_rx_clk_in] -min -add_delay 1.000 [get_ports ebi_ready]

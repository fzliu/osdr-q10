...
set_clock_groups -name sys_ss_async1 -asynchronous -group [get_clocks -include_generated_clocks a_rx_clk_in] -group [get_clocks -include_generated_clocks {pll_out[1]}]
set_clock_groups -name sys_ss_async2 -asynchronous -group [get_clocks -include_generated_clocks a_rx_clk_in] -group [get_clocks -include_generated_clocks {pll_out[2]}]
...
set_clock_groups -name sys_ss_async4 -asynchronous -group [get_clocks -include_generated_clocks a_rx_clk_in] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async5 -asynchronous -group [get_clocks -include_generated_clocks a_rx_clk_in] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
set_clock_groups -name sys_ss_async6 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {pll_out[1]}]
set_clock_groups -name sys_ss_async7 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {pll_out[2]}]
set_clock_groups -name sys_ss_async8 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[0]}]
set_clock_groups -name sys_ss_async9 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async10 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[0]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
set_clock_groups -name sys_ss_async11 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[0]}]
set_clock_groups -name sys_ss_async12 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async13 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[1]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
set_clock_groups -name sys_ss_async14 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[0]}]
set_clock_groups -name sys_ss_async15 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[1]}]
set_clock_groups -name sys_ss_async16 -asynchronous -group [get_clocks -include_generated_clocks {pll_out[2]}] -group [get_clocks -include_generated_clocks {VIRTUAL_pll_out[2]}]
...
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[1]}] -max -add_delay 0.000 [get_ports {ebi_data[*]}]
...
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[1]}] -min -add_delay 0.000 [get_ports ready]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[1]}] -max -add_delay 0.000 [get_ports ready]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[0]}] -min -add_delay 0.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[0]}] -max -add_delay 0.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[1]}] -min -add_delay 0.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[1]}] -max -add_delay 0.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[2]}] -min -add_delay 0.000 [get_ports {led_out[*]}]
set_output_delay -clock [get_clocks {VIRTUAL_pll_out[2]}] -max -add_delay 0.000 [get_ports {led_out[*]}]
...
set_property DRIVE 4 [get_ports ready]
...
set_property SLEW FAST [get_ports ready]
...
set_property DRIVE 12 [get_ports a_spi_di]
set_property DRIVE 12 [get_ports a_spi_cs]
